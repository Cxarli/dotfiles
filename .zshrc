...
setopt nomatch interactivecomments globdots
...
# don't enter directory when just path entered
unsetopt -o AUTO_CD
...
function wget {
	# BUG: wget always prints SSL_INIT to stderr
	/usr/bin/wget "$@" 2> >(grep -v '^SSL_INIT$')
}
